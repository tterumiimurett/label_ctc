...
AUTO_LABELS="${AUTO_LABELS:-tables/ctc_verification_internal_test_50.jsonl}"
DATA_DIR="${DATA_DIR:-prolific/ctc_verification_app/data_internal_50}"
BUNDLE_SIZE="${BUNDLE_SIZE:-50}"
